# Generated by Django 5.2.6 on 2026-09-19 18:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['-created_at'], name='actions_act_created_1d3976_idx'), models.Index(fields=['target_ct', 'target_id'], name='actions_act_target__f20513_idx')],
            },
        ),
    ]
